...
public class MapFragment extends Fragment {
                ...
                mMap.setOnInfoWindowClickListener(new GoogleMap.OnInfoWindowClickListener() {
                    ...
                    public void onInfoWindowClick(Marker marker) {
                        if (marker.getSnippet().contains("ev")) {
                            Intent intent = new Intent(getActivity().getApplicationContext(), EventMarkerInfoActivity.class);
    ...
    private void addEventMarkers() {
        eventMarkers.add(mMap.addMarker(eventMarkerOptions.position(new LatLng(55.744733, 37.60228)).title("Тестовый фестиваль").snippet("ev1")));
    }
